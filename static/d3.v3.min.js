! function() {
    ...
    function c() {
        var n = 0;
        for (var t in this) t.charCodeAt(0) === sa && ++n;
        return n
    }

    function s() {
        for (var n in this)
            if (n.charCodeAt(0) === sa) return !1;
        return !0
    }
    ...
    function Ut(n) {
        function t(n) {
            function t(t) {
                for (var e, u, i, o = [], a = -1, c = 0; ++a < r;) 37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), null != (u = ic[e = n.charAt(++a)]) && (e = n.charAt(++a)), (i = C[e]) && (e = i(t, null == u ? "e" === e ? " " : "0" : u)), o.push(e), c = a + 1);
        ...
        function e(n, t, e, r) {
            for (var u, i, o, a = 0, c = t.length, s = e.length; c > a;) {
                ...
                if (u = t.charCodeAt(a++), 37 === u) {
                    if (o = t.charAt(a++), i = N[o in ic ? t.charAt(a++) : o], !i || (r = i(n, e, r)) < 0) return -1
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!e && (s = c = v) && n.lineStart(), v !== c && (g = r(e, p), (me(e, g) || me(p, g)) && (p[0] += Ca, p[1] += Ca, v = t(p[0], p[1]))), v !== c) l = 0, v ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
                    else if (a && e && o ^ v) {
                        var m;
        ...
        return function(a) {
            function c(n) {
                for (var t = 0, e = d.length, r = n[1], u = 0; e > u; ++u)
                    for (var i, o = 1, a = d[u], c = a.length, s = a[0]; c > o; ++o) i = a[o], s[1] <= r ? i[1] > r && Z(s, i, n) && ++t : i[1] <= r && !Z(s, i, n) && --t, s = i;
                return 0 !== t
            }
    ...
    function kr(n) {
        for (var t = n.length, e = [0, 1], r = 2, u = 2; t > u; u++) {
            for (; r > 1 && !Z(n[e[r - 2]], n[e[r - 1]], n[u]);) r--;
            e[r++] = u
        }
        return e.slice(0, r)
    }
    ...
    function Tr(n) {
        var t = n.circle,
            ...
            a = [n];
        qr(n);
        for (var c = i; c.circle && aa(e - c.circle.x) < Ca && aa(r - c.circle.cy) < Ca;) i = c.P, a.unshift(c), qr(c), c = i;
        a.unshift(c), Yr(c);
        for (var s = o; s.circle && aa(e - s.circle.x) < Ca && aa(r - s.circle.cy) < Ca;) o = s.N, a.push(s), qr(s), s = o;
        a.push(s), Yr(s);
        var l, f = a.length;
    ...
    function Rr(n) {
        ...
        if (Bc.insert(t, c), t || e) {
            if (t === e) return Yr(t), e = zr(t.site), Bc.insert(c, e), c.edge = e.edge = Xr(t.site, c.site), Or(t), Or(e), void 0;
    ...
    function jr(n) {
        for (var t, e, r, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = $c, d = v.length; d--;)
            if (i = v[d], i && i.prepare())
                for (a = i.edges, c = a.length, o = 0; c > o;) l = a[o].end(), r = l.x, u = l.y, s = a[++o % c].start(), t = s.x, e = s.y, (aa(r - t) > Ca || aa(u - e) > Ca) && (a.splice(o, 0, new Wr($r(i.site, l, aa(r - f) < Ca && p - u > Ca ? {
                    x: f,
                    y: aa(t - f) < Ca ? e : p
                } : aa(u - p) < Ca && h - r > Ca ? {
                    x: aa(e - p) < Ca ? t : h,
    ...
    function Ir(n) {
        for (var t, e = Xc, r = Pe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--;) t = e[u], (!Zr(t, n) || !r(t) || aa(t.a.x - t.b.x) < Ca && aa(t.a.y - t.b.y) < Ca) && (t.a = t.b = null, e.splice(u, 1))
    }
    ...
    function tu(n, t) {
        ...
        for (Xc = [], $c = new Array(n.length), Bc = new Jr, Jc = new Jr;;)
            if (u = Wc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== e || i.y !== r) && ($c[i.i] = new Ur(i), Rr(i), e = i.x, r = i.y), i = n.pop();
            else {
                if (!u) break;
                Tr(u.arc)
            }
    ...
    function fu(n, t) {
        ...
        for (a < t.length && s.push(t.substring(a)), r = 0, i = l.length;
            ...
            if (o = l[r], o.x == e[0]) {
                ...
                l.splice(r, 1), i--, r--
            } else o.x = lu(parseFloat(e[0]), parseFloat(o.x));
    ...
    function fi(n, t) {
        var e = n.children;
        if (e && (u = e.length))
            for (var r, u, i = -1; ++i < u;) t(r = fi(e[i], t), n) > 0 && (n = r);
        return n
    }
    ...
    function Ei(n, t, e, r) {
        ...
        if (n.x = t += r * n.x, n.y = e += r * n.y, n.r *= r, u)
            for (var i = -1, o = u.length; ++i < o;) Ei(u[i], t, e, r)
    }
    ...
    function vo(n, t) {
        if (t.length < 1 || n.length != t.length && n.length != t.length + 2) return ao(n);
    ...
    function yo(n) {
        ...
        for (n.push(n[e - 1]); ++t <= e;) r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), wo(c, o, a);
        return n.pop(), c.push("L", r), c.join("")
    }

    function xo(n) {
        if (n.length < 4) return ao(n);
        for (var t, e = [], r = -1, u = n.length, i = [0], o = [0]; ++r < 3;) t = n[r], i.push(t[0]), o.push(t[1]);
        for (e.push(bo(Ss, i) + "," + bo(Ss, o)), --r; ++r < u;) t = n[r], i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), wo(e, i, o);
        return e.join("")
    }

    function Mo(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4;) e = n[r % u], o.push(e[0]), a.push(e[1]);
        for (t = [bo(Ss, o), ",", bo(Ss, a)], --r; ++r < i;) e = n[r % u], o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), wo(t, o, a);
        return t.join("")
    }
    ...
    function ko(n) {
        for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = r[0] = So(u, i); ++t < e;) r[t] = (o + (o = So(u = i, i = n[t + 1]))) / 2;
        return r[t] = o, r
    }

    function Eo(n) {
        for (var t, e, r, u, i = [], o = ko(n), a = -1, c = n.length - 1; ++a < c;) t = So(n[a], n[a + 1]), aa(t) < Ca ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), o[a] = u * e, o[a + 1] = u * r));
    ...
    function Co(n) {
        for (var t, e, r, u = -1, i = n.length; ++u < i;) t = n[u], e = t[0], r = t[1] + xs, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
        return n
    }
    ...
    $o.selection.enter = D, $o.selection.enter.prototype = xa, xa.append = ma.append, xa.empty = ma.empty, xa.node = ma.node, xa.call = ma.call, xa.size = ma.size, xa.select = function(n) {
        ...
        for (var n, t, e = Es || ++zs, r = [], u = As || {
            ...
            r.push(n = []);
            for (var a = this[i], c = -1, s = a.length; ++c < s;)(t = a[c]) && Ho(t, c, e, u), n.push(t)
        }
        return Po(r, e)
    ...
    $o.interpolateZoom = function(n, t) {
        ...
        function l() {
            ...
            function e() {
                for (var t = $o.event.changedTouches, e = 0, i = t.length; i > e; ++e) v[t[e].identifier] = null;
                var o = n(),
                    c = Date.now();
                if (1 === o.length) {
                    if (500 > c - x) {
            ...
            function f() {
                if ($o.event.touches.length) {
                    for (var t = $o.event.changedTouches, e = 0, r = t.length; r > e; ++e) delete v[t[e].identifier];
    ...
    var $a, Ba, Wa, Ja, Ga, Ka = Ko[h(Ko, "requestAnimationFrame")] || function(n) {
        setTimeout(n, 17)
    };
    ...
    $o.geo.path = function() {
        ...
        return n.area = function(n) {
            ...
            return Tc = Rc = -(zc = qc = 1 / 0), $o.geo.stream(n, u(Pc)), [
                [zc, qc],
                [Tc, Rc]
            ]
    ...
    $o.interpolateTransform = Du, $o.layout = {}, $o.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            if (g)
                for (Vu(t = $o.geom.quadtree(m), r, o), e = -1; ++e < _;)(a = m[e]).fixed || t.visit(n(a));
    ...
    $o.layout.histogram = function() {
        ...
        function n(n, i) {
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], s = i._tree.mod, l = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = li(a), i = si(i), a && i;) c = si(c), o = li(o), o._tree.ancestor = n, u = a._tree.prelim + f - i._tree.prelim - s + e(a, i), u > 0 && (mi(yi(a, n, r), n, u), s += u, l += u), f += a._tree.mod, s += i._tree.mod, h += c._tree.mod, l += o._tree.mod;
        ...
        var t, e = $o.layout.hierarchy().sort(xi),
            r = 0,
            u = [1, 1];
    ...
    Ls.call = ma.call, Ls.empty = ma.empty, Ls.node = ma.node, Ls.size = ma.size, $o.transition = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a;) {
            i.push(t = []);
            for (var c = this[o], s = -1, l = c.length; ++s < l;)(r = c[s]) && (e = n.call(r, r.__data__, s, o)) ? ("__data__" in r && (e.__data__ = r.__data__), Ho(e, s, u, r.__transition__[u]), t.push(e)) : t.push(null)
        }
        return Po(i, u)
        ...
        for (var n, t, e, r, u = this.id, i = ++zs, o = [], a = 0, c = this.length; c > a; a++) {
            o.push(n = []);
            for (var t = this[a], s = 0, l = t.length; l > s; s++)(e = t[s]) && (r = Object.create(e.__transition__[u]), r.delay += r.duration, Ho(e, s, i, r)), n.push(e)
        }
        return Po(o, i)
    }, $o.svg.axis = function() {
        function n(n) {
    ...
    $o.svg.brush = function() {
        ...
        function u() {
            ...
            if ($o.event.changedTouches ? z.on("touchmove.brush", v).on("touchend.brush", y) : z.on("mousemove.brush", v).on("mouseup.brush", y), S.interrupt().selectAll("*").interrupt(), C) L[0] = l[0] - L[0], L[1] = f[0] - L[1];
            else if (k) {
                var q = +/w$/.test(k),
                    T = +/^n/.test(k);
